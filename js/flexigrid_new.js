...
(function($){ 
        ...
        { 
                ...
                $(t) 
                .show() //show if hidden 
                .attr({cellPadding: 0, cellSpacing: 0, border: 0})  //remove padding 
and spacing 
...
ow: ow, n : n }; 
                                        ...
                                        { 
                                                ...
                                                this.vresize = {h: p.height, sy: e.pageY, w: p.width, sx: 
e.pageX, hgo: hgo}; 
                                        } 
...
(); 
                                                ...
                                                $(this.colCopy).css 
({position:'absolute',float:'left',display:'none', textAlign: 
obj.align}); 
...
e.pageY > this.hset.bottom || e.pageY < this.hset.top) 
                                        ...
                                        $(this.colCopy).css({top:e.pageY + 10,left:e.pageX + 20, display: 
'block'}); 
                                } 
                        }, 
                        dragEnd: function () { 
...
+')',this.nDiv)); 
                                        if ($.browser.msie&&$.browser.version<7.0) $('tr:eq('+cdrop+') 
input',this.nDiv)[0].checked = true; 
                                        this.hDiv.scrollLeft = this.bDiv.scrollLeft; 
                        }, 
                        scroll: function() { 
                                        this.hDiv.scrollLeft = this.bDiv.scrollLeft; 
                                        ...
                                        ( 
                                         ...
                                         function(i,row) 
                                                { 
                                                        ...
                                                        if ($('thead',this.gDiv).length<1) //handle if grid has no 
headers 
                                                        { 
...
sortorder: p.sortorder, query: p.query, qtype: p.qtype}; 
                ...
                if(p.extras !== false) { 
                                  for(i=0;i<p.extras.length;i++) { 
                                    param[param.length] = { name :  p.extras[i][0] , value : 
p.extras[i][1] }; 
                  } 
                                } 
                                if (p.params) 
                                        { 
                                                for (var pi = 0; pi < p.params.length; pi++) param[param.length] 
= p.params[pi]; 
                                        } 
                                        $.ajax({ 
                                           type: p.method, 
                                           ...
                                           error: function(data) { try { if (p.onError) p.onError 
(data); } catch (e) {} } 
                                         }); 
                        }, 
                        doSearch: function () { 
                                                ...
                                                function () 
                                                        { 
                                                                        ...
                                                                        if (p.sortname==$(pth).attr('abbr')&&p.sortname) 
                                                                         ...
                                                                         $(tdDiv).css({textAlign:pth.align,width: $('div:first',pth) 
[0].style.width}); 
...
content 
                        ...
                        { 
                                ...
                                return {ht:ht,wt:wt,top:top,left:left,pdl:pdl, pdt:pdt, pht:pht, 
pwt: pwt}; 
                        }, 
                        addRowProp: function() 
                        { 
                                        ...
                                        ( 
                                                function () 
                                                        ...
                                                        .click( 
                                                                function (e) 
                                                                        { 
                                                                                var obj = (e.target || e.srcElement); if (obj.href || 
obj.type) return true; 
                                                                                $(this).toggleClass('trSelected'); 
                                                                                if (p.singleSelect) $(this).siblings().removeClass 
('trSelected'); 
                                                                        } 
                                                        ) 
                                                        .mousedown( 
...
button 
                ...
                if (p.usepager) g.pDiv = document.createElement('div'); //create 
pager container 
                        ...
                        for (i=0;i<p.buttons.length;i++) 
                                { 
                                        ...
                                        { 
                                                ...
                                                if ($.browser.msie&&$.browser.version<7.0) 
                                                { 
                                                        $(btnDiv).hover(function(){$(this).addClass('fbOver');},function 
...
g.colresize&&$(this).attr('abbr')) $('div',this).addClass 
('s'+p.sortorder); 
...
('borderLeftWidth')); 
                                                        ...
                                                        function(){ 
                                                                ...
                                                                if ($(this).attr('abbr')!=p.sortname) $('div',this).removeClass 
('s'+p.sortorder); 
...
('borderRightWidth'))) ? 0 : parseInt($('div',cdcol).css 
('borderRightWidth'))); 
...
0 : parseInt($('div',cdcol).css('paddingRight'))); 
                                        ...
                                        { 
                                                ...
                                                { 
                                                        ...
                                                        $(cgDiv).hover( 
                                                                ...
                                                                function () { if (!g.colresize) $(this).removeClass 
('dragging') } 
                                                        ); 
                                                } 
                                        } 
                ...
                if ($.browser.msie&&$.browser.version<7.0) 
                { 
                        $(g.rDiv).hover(function(){$(this).addClass('hgOver');},function(){$ 
...
g.changePage('input')}); 
                if ($.browser.msie&&$.browser.version<7) $('.pButton',g.pDiv).hover 
(function(){$(this).addClass('pBtnOver');},function(){$ 
...
('fast',function(){$('.sDiv:visible input:first',g.gDiv).trigger 
('focus');});}); 
                                //add search box 
...
sitems[s].display + "&nbsp;&nbsp;</option>"; 
                                ...
                                $(g.sDiv).append("<div class='sDiv2'>Quick Search <input type='text' size='30' name='q' class='qsbox' /> <select 
name='qtype'>"+sopt+"</select> <input type='button' value='Clear' /></ 
div>"); 
                                $('input[name=q],select[name=qtype]',g.sDiv).keydown(function(e){if 
(e.keyCode==13) g.doSearch()}); 
                                $('input[value=Clear]',g.sDiv).click(function(){$('input 
[name=q]',g.sDiv).val(''); p.query = ''; g.doSearch(); }); 
                                $(g.bDiv).after(g.sDiv); 
                        } 
                } 
                ...
                { 
                        ...
                        if (p.showTableToggleBtn) 
                                { 
                                        $(g.mDiv).append('<div class="ptogtitle" title="Minimize/Maximize 
Table"><span></span></div>'); 
                ...
                { 
                        ...
                        g.nDiv.innerHTML = "<table cellpadding='0' cellspacing='0'><tbody></ 
tbody></table>"; 
                        $(g.nDiv).css( 
                        { 
                                marginBottom: (gh * -1), 
...
(this).prev().find('input')[0].checked) return false; 
                        ...
                        ( 
                                function () 
                                        { 
                                                if ($ 
('input:checked',g.nDiv).length<p.minColToggle&&this.checked==false) 
return false; 
                ...
                $(g.bDiv) 
                .hover(function(){$(g.nDiv).hide();$(g.nBtn).hide();},function(){if 
(g.multisel) g.multisel = false;}) 
                ; 
                $(g.gDiv) 
        ...
        $.fn.flexToggleCol = function(cid,visible) { // function to reload 
grid 
                return this.each( function() { 
        ...
        $.fn.noSelect = function(p) { //no select plugin by me :-) 
                ...
                return this.each(function () 
                        { 
                                if ($.browser.msie||$.browser.safari) $(this).bind 
...
{return false;}); 
                ...
                return this.each(function () 
                        { 
                                if ($.browser.msie||$.browser.safari) $(this).unbind 
('selectstart'); 
                                else if ($.browser.mozilla) $(this).css 
